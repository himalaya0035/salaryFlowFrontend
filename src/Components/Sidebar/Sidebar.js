  ...
  return (
    <div className='hidden z-20 px-6 py-4 fixed top-0 left-0 h-screen bg-white border-r w-[270px] md:block'>
      ...
      <div className='mt-8 space-y-4'>
        ...
        <NavLink to="/departments" className={({isActive} ) => isActive ? normalClasses + activeClasses : normalClasses}><img src="department.svg" className='w-6' alt="" /><span className='text-base'>Departments</span></NavLink>
